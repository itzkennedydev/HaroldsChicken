              ...
              <div className="p-6 sm:p-7 md:p-10 space-y-6 sm:space-y-7">
                <div className="space-y-3">
                  ...
                  <p className="text-base sm:text-lg text-slate-700 leading-relaxed md:leading-8">
                    Access to this application has been disabled due to an outstanding billing issue on the account.
                    Service will be restored automatically once the required payment has been completed.
                  </p>
                </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-5 sm:p-6 space-y-2.5">
                  ...
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
                    ...
                    Reference: billing hold. Service will resume automatically once the required payment is completed.
                  </p>
                  <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
