...
export default function Page() {
  ...
  return (
    <>
      ...
      <article 
        ref={sectionRef} 
        className="pt-20 sm:pt-16 pb-12 md:py-20 lg:py-24 bg-white"
      >
        <Container>
          <div className={`transition-all duration-1000 ${
            ...
            <div className="grid md:grid-cols-[1fr,2fr] gap-6 items-start">
              ...
              <div className="space-y-12">
                {/* Header Section */}
                <header>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#202124] mb-3 uppercase">
                ...
                <section className="space-y-3">
                  ...
                  <blockquote className="border-l-4 border-[#407E57] pl-6 py-3 my-6">
                ...
                {/* Early Life */}
                <section>
                  <h2 className="text-2xl font-bold text-[#202124] mb-3 uppercase">Early Challenges & Choices</h2>
                ...
                {/* Business Success */}
                <section>
                  <h2 className="text-2xl font-bold text-[#202124] mb-3 uppercase">Building Success Through Mindset</h2>
                  <div className="space-y-3">
                    <p className="text-lg text-[#333536] leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
                      <div className="bg-[#F8FAF8] p-4 rounded-lg">
                        <h3 className="text-xl font-bold text-[#407E57] mb-2">Dedication</h3>
                        <p className="text-[#333536]">
                          Commitment to excellence in every venture and initiative
                        </p>
                      </div>
                      <div className="bg-[#F8FAF8] p-4 rounded-lg">
                        <h3 className="text-xl font-bold text-[#407E57] mb-2">Discipline</h3>
                        <p className="text-[#333536]">
                          Maintaining focus and drive even through challenging times
                        </p>
                      </div>
                      <div className="bg-[#F8FAF8] p-4 rounded-lg">
                        <h3 className="text-xl font-bold text-[#407E57] mb-2">Determination</h3>
                        <p className="text-[#333536]">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-[#202124] mb-3 uppercase">Philosophy & Community Impact</h2>
                  <div className="space-y-3">
                    <p className="text-lg text-[#333536] leading-relaxed">
